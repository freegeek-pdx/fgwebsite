...
<fieldset class="options metabox-holder">
	...
	<div id="formbuilder-admin-left">
		...
		<div class="info-box-formbuilder postbox">
			...
			?>
			<h3 class='info-box-title hndle'><?php _e('Permissions Configuration:'); ?> </h3>
			<div class="inside">
					...
					<table width="100%">
						<tr>
							...
							<td>
								...
								<label for="permissions_admin_connect"><?php _e('Connect Forms'); ?></label>
								...
								<label for="permissions_admin_create"><?php _e('Create Forms'); ?></label>
								...
								<label for="permissions_admin_manage"><?php _e('Manage Settings'); ?></label>
							</td>
						</tr>
						<tr>
							<td><?php _e('Editors:'); ?></td>
							<td>
								...
								<label for="permissions_editors_connect"><?php _e('Connect Forms'); ?></label>
								...
								<label for="permissions_editors_create"><?php _e('Create Forms'); ?></label>
								...
								<label for="permissions_editors_manage"><?php _e('Manage Settings'); ?></label>
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<label for="permissions_authors_connect"><?php _e('Connect Forms'); ?></label>
								...
								<label for="permissions_authors_create"><?php _e('Create Forms'); ?></label>
								...
								<label for="permissions_authors_manage"><?php _e('Manage Settings'); ?></label>
							</td>
						</tr>
					</table>
		...
		<div class="info-box-formbuilder postbox">
			...
			?>
			<h3 class='info-box-title hndle'>Referrer Info: <?php 
