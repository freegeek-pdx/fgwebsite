...
function wpsc_get_htaccess_info() {
	...
	$rules .= "RewriteCond %{REQUEST_URI} ^/newsletter\n";
	...
	$rules .= "RewriteRule ^(.*) \"{$inst_root}cache/supercache/%{SERVER_NAME}{$home_root_lc}newsletter/$1/index-https.html.gz\" [L]\n\n";
	...
	$rules .= "RewriteRule ^(.*) \"{$inst_root}cache/supercache/%{SERVER_NAME}{$home_root_lc}newsletter/$1/index.html.gz\" [L]\n\n";

	$rules .= "RewriteCond %{REQUEST_URI} ^/newsletter\n";
	$rules .= "CONDITION_RULES";
	$rules .= "RewriteCond %{HTTPS} on\n";
	$rules .= "RewriteCond {$apache_root}{$inst_root}cache/supercache/%{SERVER_NAME}{$home_root_lc}$1/index-https.html -f\n";
	$rules .= "RewriteRule ^(.*) \"{$inst_root}cache/supercache/%{SERVER_NAME}{$home_root_lc}newsletter/$1/index-https.html\" [L]\n\n";

	$rules .= "RewriteCond %{REQUEST_URI} ^/newsletter\n";
	$rules .= "CONDITION_RULES";
	$rules .= "RewriteCond %{HTTPS} !on\n";
	$rules .= "RewriteCond {$apache_root}{$inst_root}cache/supercache/%{SERVER_NAME}{$home_root_lc}$1/index.html -f\n";
	$rules .= "RewriteRule ^(.*) \"{$inst_root}cache/supercache/%{SERVER_NAME}{$home_root_lc}newsletter/$1/index.html\" [L]\n\n\n";
