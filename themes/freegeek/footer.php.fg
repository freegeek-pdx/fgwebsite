		...
		<div id="<?php print $fg_footer_id; ?>">
			<div id="footer_content">
				...
				<p class="center">Helping the needy get nerdy since the begining of the third millenium</p>
				
				
			</div><!-- id=footer_content -->
			<div id="footer_bottom">
				<p>Stuff on this site is covered by a <a href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons License</a></p>
			</div>
