...
?>
				...
				<div id="post_<?php the_ID(); ?>" class="post<?php echo($sPostClass); ?>">
					...
					<ul class="metalinks">
						<li class="icon comment"><a href="<?php the_permalink() ?>#comments"><?php comments_number(__('No Responses', 'gluedideas_subtle'),__('One Response', 'gluedideas_subtle'),'% ' . __('Responses', 'gluedideas_subtle')); ?></a></li>
