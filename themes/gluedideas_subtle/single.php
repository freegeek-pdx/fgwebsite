...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			...
			<div id="post_meta" class="prominent reduced"><div class="inner">
				...
				<dl class="metadata odd">
					...
					<dd class="icon comment"><a href="#comments"><?php comments_number(__('No Responses', 'gluedideas_subtle'),__('One Response', 'gluedideas_subtle'),'% ' . __('Responses', 'gluedideas_subtle')); ?></a></dd>
				</dl>
				...
				<dl class="metadata even">
					...
					<dd class="icon entry"><a href="<?php echo get_author_link(0, $authordata->ID, $authordata->user_nicename); ?>"><?php _e("From This Author", 'gluedideas_subtle'); ?></a></dd>
				...
				<dl class="metadata odd">
					<dt><?php _e("Categories and Tags", 'gluedideas_subtle'); ?></dt>
					<dd class="icon category"><?php the_category('</dd><dd class="icon category">') ?></dd>
					<?php if (function_exists('the_tags')) { the_tags('<dd class="icon tag">',', ','</dd>'); } ?>
				</dl>
