...
<?php endif; ?>
		...
		<?php wp_loginout(); ?>
			...
			<!--
			<a href="http://gluedideas.com/" class="logo"><img src="<?php bloginfo('stylesheet_directory'); ?>/assets/images/logo_gluedideas.gif" alt="<?php _e("Design by Glued Ideas", 'gluedideas_subtle'); ?>" align="top" border="0" /></a>
